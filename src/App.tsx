...
const mensajes = [
  "Nuni, tu sabiduría y tu ternura hacen del mundo un lugar mejor. Nunca dejes de ser como eres. Te admiro y te amo.",
  "Nuni, tu amor es el refugio más seguro que tengo. Gracias por ser mi apoyo incondicional.",
  "Eres la razón por la que creo en la bondad del mundo. Te amo más de lo que las palabras pueden expresar.",
  "Cada día contigo es un regalo. Gracias por ser la mejor nuni del universo.",
  "Tu sonrisa ilumina mis días y tu sabiduría guía mis pasos. Eres una inspiración para mí.",
  "Nuni, tu amor y sacrificio no pasan desapercibidos. Te valoro más de lo que puedes imaginar.",
